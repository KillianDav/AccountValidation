...
{
    internal class Standard10ModulusCheck : ModulusCheck
    {
        internal Standard10ModulusCheck(BankAccountDetails bankAccountDetails, ModulusWeighting modulusWeighting) : base(bankAccountDetails, modulusWeighting)
        {
        }
